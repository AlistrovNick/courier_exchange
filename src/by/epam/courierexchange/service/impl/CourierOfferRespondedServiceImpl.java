...
public class CourierOfferRespondedServiceImpl implements CourierOfferRespondedService {
    ...
    public List<ClientOffer> findByClient(User client, OfferStatusType status) throws ServiceException {
        List<ClientOffer> clientOfferList = new ArrayList<>();
        try {
            clientOfferList.addAll(CourierOfferRespondedDaoImpl.INSTANCE.findByClientAndStatus(client, status));
        } catch (DaoException e) {
