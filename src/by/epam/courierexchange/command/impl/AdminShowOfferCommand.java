...
public class AdminShowOfferCommand implements Command {
    ...
    public String execute(SessionRequestContent content) throws CommandException {
        ...
        try {
            courierOfferList = new CourierOfferServiceImpl().findByStatus(OfferStatusType.IN_PROCESS);
            clientOfferList = new ClientOfferServiceImpl().findByStatus(OfferStatusType.IN_PROCESS);
