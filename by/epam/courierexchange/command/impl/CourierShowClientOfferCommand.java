...
public class CourierShowClientOfferCommand implements Command {
    ...
    public String execute(SessionRequestContent content) throws CommandException {
        ...
        try {
            clientList.addAll(new ClientOfferService().find(OfferStatusType.ACCEPT));
            List<Integer> clientOfferIdResponded = new ClientOfferRespondedService().findOfferId(user, OfferStatusType.IN_PROCESS);
